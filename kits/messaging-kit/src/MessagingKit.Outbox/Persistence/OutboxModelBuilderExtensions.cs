...
public static class OutboxModelBuilderExtensions
{
    ...
    public static ModelBuilder AddOutbox(this ModelBuilder builder, string schema = "messaging", string table = "outbox")
    {
        ...
        builder.Entity<OutboxMessage>(entity =>
        {
            ...
            entity.Property(m => m.Destination).HasColumnName("destination").HasMaxLength(200);
